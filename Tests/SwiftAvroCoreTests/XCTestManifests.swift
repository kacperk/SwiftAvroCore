...
extension AvroBinaryReaderTest {
    ...
    static let __allTests__AvroBinaryReaderTest = [
        ...
        ("testReadLong", testReadLong),
        ("testReadNull", testReadNull),
        ("testReadString", testReadString),
    ]
}

extension AvroDatumReaderTest {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__AvroDatumReaderTest = [
        ("testInt", testInt),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(AvroDatumReaderTest.__allTests__AvroDatumReaderTest),
